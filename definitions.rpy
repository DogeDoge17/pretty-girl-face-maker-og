...
define sn = DynamicCharacter('sn_name', image='sans', what_prefix='* ', what_suffix='', ctc="ctc", ctc_position="fixed")
...
#like that one tyler the creator song
default domo_23 = None
